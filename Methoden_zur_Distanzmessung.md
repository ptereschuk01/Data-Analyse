...
- Kosinus: \( \cos(\theta) = \frac{1*4 + 2*6}{\sqrt{1^2+2^2}\sqrt{4^2+6^2}} = 0,986 \) → Distanz \( 1-0,986=0,014 \)

**EN:**  
- Euclidean: \( \sqrt{(4-1)^2 + (6-2)^2} = \sqrt{9+16} = 5 \)  
- Manhattan: \( |4-1| + |6-2| = 3 + 4 = 7 \)  
- Cosine: \( \cos(\theta) = \frac{1*4 + 2*6}{\sqrt{1^2+2^2}\sqrt{4^2+6^2}} = 0.986 \) → Distance \( 1-0.986 = 0.014 \)
